...
class PointPublisher(Node):
    ...
    def publish_point(self):
        marker = Marker()
        marker.header.frame_id = "base_link"   # or any frame you want
...
#[-0.35362, 0.0297327, 0.637621, 0.0, 0.0, 0.0]
#[-0.30362, -0.1702673, 0.587621, 0.0, 0.0, 0.0]]
#x: -291.86428057970465
# y: 62.73702133841214
# z: 721.3512831585286
#[-0.35362, 0.0297327, #0.637621, 0.0, 0.0, 0.0]
