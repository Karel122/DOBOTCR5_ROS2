...
#include "dobot_msgs_v4/srv/detail/transform__rosidl_typesupport_fastrtps_c.h"
...
using _Transform_Request__ros_msg_type = dobot_msgs_v4__srv__Transform_Request;
...
size_t get_serialized_size_dobot_msgs_v4__srv__Transform_Request(
  const void * untyped_ros_message,
...
static uint32_t _Transform_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dobot_msgs_v4__srv__Transform_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v4
size_t max_serialized_size_dobot_msgs_v4__srv__Transform_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dobot_msgs_v4__srv__Transform_Request;
    is_plain =
      (
...
static size_t _Transform_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dobot_msgs_v4__srv__Transform_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, Transform_Request)() {
...
using _Transform_Response__ros_msg_type = dobot_msgs_v4__srv__Transform_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v4
size_t get_serialized_size_dobot_msgs_v4__srv__Transform_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Transform_Response__ros_msg_type * ros_message = static_cast<const _Transform_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_dobot_msgs_v4__srv__Transform_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v4
size_t max_serialized_size_dobot_msgs_v4__srv__Transform_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dobot_msgs_v4__srv__Transform_Response;
    is_plain =
      (
      offsetof(DataType, rz) +
      last_member_size
...
static size_t _Transform_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dobot_msgs_v4__srv__Transform_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, Transform_Response)() {
...
// already included above
// #include "dobot_msgs_v4/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "dobot_msgs_v4/srv/transform.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v4, srv, Transform)() {
