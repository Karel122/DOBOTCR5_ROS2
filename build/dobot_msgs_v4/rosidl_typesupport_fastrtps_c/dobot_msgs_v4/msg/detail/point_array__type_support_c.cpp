...
#include "dobot_msgs_v4/msg/detail/point_array__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // vrednosti
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // vrednosti

// forward declare type support functions


using _PointArray__ros_msg_type = dobot_msgs_v4__msg__PointArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: vrednosti
  {
    size_t size = ros_message->vrednosti.size;
    auto array_ptr = ros_message->vrednosti.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: vrednosti
  {
    ...
    if (ros_message->vrednosti.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->vrednosti);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->vrednosti, size)) {
      fprintf(stderr, "failed to create array for field 'vrednosti'");
      return false;
    }
    auto array_ptr = ros_message->vrednosti.data;
...
static uint32_t _PointArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dobot_msgs_v4__msg__PointArray(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dobot_msgs_v4__msg__PointArray;
    is_plain =
      (
...
static size_t _PointArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dobot_msgs_v4__msg__PointArray(
